    ...
    ?>
		...
		<div class="project">
			<div class="project-info">
				...
				<div class="project-title">Keeping It Canadian</div>
				<div class="project-meta">2017 | Design Thinking + Data Visualization</div>

				<div class="project__break"></div>

				<div class="project-info__left">
					<li class="project-info__list-left project-info__list-left--first"><span class="light-list">Length: </span>Ongoing</li>
					<li class="project-info__list-left"><span class="light-list">Tools: </span>Sketch, Adobe Illustrator, InDesign, </li>
				...
				<div class="project-info__right">
					<li class="project-info__list-right">> Infographic Map</li>
				</div>
			</div>
