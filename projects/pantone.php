    ...
    ?>
		...
		<div class="project">
			<div class="project-info">
				...
				<div class="project-title">Pantone</div>
				<div class="project-meta">2018 | UX Case Study + Redesign</div>

				<div class="project__break"></div>

				<div class="project-info__left">
					<li class="project-info__list-left project-info__list-left--first"><span class="light-list">Length:</span> 5 Weeks</li>
					<li class="project-info__list-left"><span class="light-list">Tools:</span> Sketch, Google Forms</li>
				...
				<div class="project-info__right">
					<li class="project-info__list-right">> Pantone Refit</li>
