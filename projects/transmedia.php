    ...
    ?>
		...
		<div class="project">
			<div class="project-info">
				...
				<div class="project-meta">2018 | Game Design + Interactive Media</div>
				...
				<div class="project-info__left">
					...
					<li class="project-info__list-left"><span class="light-list">Languages: </span>C#, Python</li>
				</div>
				...
				<div class="project-info__right">
					<li class="project-info__list-right">> Download</li>
				</div>
			</div>
