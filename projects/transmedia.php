...
<html>
	<head>
		...
		<link rel="stylesheet" href="../styles/project_styles/uni.css">
    ...
    ?>
		...
		<div class="project">
			<div class="project-info">
				...
				<div class="project-title">Project 151</div>
				<div class="project-meta">2018 | Transmedia Game</div>

				<div class="project__break"></div>

				<div class="project-info__left">
					<li class="project-info__list-left project-info__list-left--first"><span class="light-list">Length: </span>In Progress</li>
					<li class="project-info__list-left"><span class="light-list">Tools: </span>Unity, Maya 2018</li>
					<li class="project-info__list-left"><span class="light-list">Languages: </span>C#, Python, Javascript</li>
				...
				<div class="project-info__right"> 
					<li class="project-info__list-left"><a class="demipeppas" style="text-decoration: underline;" target="_blank" href="http://www.demipeppas.com/"><i>Demi Peppas</i></a><br><a class="benreimer" style="text-decoration: underline;" target="_blank" href="http://benreimer.design/"><i>Ben Reimer</i></a><br><a class="kasparso" style="text-decoration: underline;" target="_blank" href="http://www.kasparso.com/"><i>Kaspar So</i></a></li>				
				</div>
			</div>
