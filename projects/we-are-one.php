		...
		<div class="project">
			<div class="project-info">
				...
				<div class="project-info__left">
					...
					<li class="project-info__list-left"><span class="light-list">With:</span> <a style="text-decoration: underline;" target="_blank" href="http://www.elyseturton.com/">Elyse Turton</a></li>
				...
				<div class="project-info__right">
					<li class="project-info__list-right">> <a href="http://www.artgalleryofmississauga.com/" target="_blank">Art Gallery of Mississauga</a></li>
				</div>
			</div>
