...
<html>
		...
		<div class="project">
			<div class="project-info">
				...
				<div class="project-info__left">
					...
					<li class="project-info__list-left"><span class="light-list">Tools:</span> Adobe Photoshop, Illustrator, HTML/CSS</li>
				...
				<div class="project-info__right">
					<li class="project-info__list-right">> Instagram</li>
					<li class="project-info__list-right">> Online Store</li>
				</div>
			</div>
			<div class="project-hero rising__1"></div>
				<div class="project__copy">
				<div class="bdy bdy__h">Concept</div>
				<div class="bdy bdy__s">Nike and Addidas ads are there to get you hyped</div>
			...
			<div class="project__copy">
				...
				<div class="bdy bdy__s">Nike, Addidas, Supreme, Walmart, Costco, McDonalds</div>
 ...
 -->
			...
			<div class="project__copy">
				...
				<div class="bdy bdy__s">Final Results & Documentation File ((LINK))</div>
